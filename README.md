...
現在、機能追加及びテストコードの作成中です。  

サンプルデータは data/ にあります。  
データの再生成は scripts/ 下のスクリプトで可能です。  

## なぜこれを作ったか:  
実務のブランクを鑑み、バックエンドを中心にしながら近年主流の言語であるPythonを学習するために作成しています。    
...
・保守性の向上: 定数をconstants.py、汎用関数をutils.pyにまとめ、型ヒントの有無に気を付けてチーム開発を想定した可視性の高いコードを記述しています。  
